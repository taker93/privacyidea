...
SQLALCHEMY_DATABASE_URI = os.environ.get(
    'SQLALCHEMY_DATABASE_URI', 'sqlite:////data/privacyidea/privacyidea.db')
PI_ENCFILE = os.environ.get("PI_ENCFILE", "/data/privacyidea/encfile")
PI_HSM = os.environ.get("PI_HSM", "default")
PI_AUDIT_MODULE = os.environ.get(
    "PI_AUDIT_MODULE", "privacyidea.lib.auditmodules.sqlaudit")
PI_AUDIT_KEY_PRIVATE = os.environ.get(
    "PI_AUDIT_KEY_PRIVATE", "/data/privacyidea/keys/private.pem")
PI_AUDIT_KEY_PUBLIC = os.environ.get(
    "PI_AUDIT_KEY_PUBLIC", "/data/privacyidea/keys/public.pem")
...
PI_EXTERNAL_LINKS = os.environ.get(
    "PI_EXTERNAL_LINKS", "True").lower() == "true"
# PI_GNUPG_HOME = "gpg"
